...
global params;
params = zeros(5,1);
f = figure('Units','inches','Position',[0,0,8,8]);
...
Slider1 = uicontrol(paramPanel, 'style','slide',...
    'unit','normalized',...
    'position',[.05 .05 .4 .08],...
    'min',-range,'max',range,'val',(rand()-0.5)*range*2);
...
Slider5 = uicontrol(paramPanel, 'style','slide',...
    ...
    'position',[.5 .3 .4 .08],...
    'min',-pi,'max',pi,'val',0);
Slider6 = uicontrol(paramPanel, 'style','slide',...
    'unit','normalized',...
    'position',[.5 .55 .4 .08],...
    'min',-range,'max',range,'val',(rand()-0.5)*range*2);
Slider7 = uicontrol(paramPanel, 'style','slide',...
    'unit','normalized',...
    'position',[.5 .65 .4 .08],...
    'min',-range,'max',range,'val',(rand()-0.5)*range*2);
...
text6 = uicontrol(dispPanel, 'style','text',...
    'unit','normalized',...
    'position',[.2 .85 .3 .1],'string','Color Range');
text7 = uicontrol(dispPanel, 'style','text',...
    'unit','normalized',...
    'position',[.5 .85 .3 .1],'string','Density');
text8 = uicontrol(paramPanel, 'style','text',...
    'unit','normalized',...
    'position',[.9 .65 .1 .08],'string','Ortho Bias');
text9 = uicontrol(paramPanel, 'style','text',...
    'unit','normalized',...
    'position',[.9 .55 .1 .08],'string','Centroid Bias');
agent1Text = uicontrol(dispPanel, 'style','text',...
    'unit','normalized',...
    'position',[.02 .8 .2 .1],'string','Agent 1:');
...
agent2Text = uicontrol(dispPanel, 'style','text',...
    'unit','normalized',...
    'position',[.02 .7 .2 .1],'string','Agent 2:');
...
while(true)
   ...
   params(4) = Slider4.Value;
   params(5) = Slider5.Value;
   params(6) = Slider6.Value;
   params(7) = Slider7.Value;
